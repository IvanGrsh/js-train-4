...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  return `${charCodeAtResult}, ${codePointAtResult}, ${atResult}, ${charAtResult} `;
...
function padString(original, length, padWith, side) {
  ...
  //   if (start.padStart(original, length, padWith, side)) {
  //     return "Error: side should be either 'start' or 'end'";
  //   }
  //   if (end.padEnd(original, length, padWith, side)) {
  //     return "Error: side should be either 'start' or 'end'";
  //   } else {
  //     return "Error: side should be either 'start' or 'end'";
  //   }
  //   let start = start.padStart(original, length, padWith, side);
  //   let end = end.padEnd(original, length, padWith, side);
  //   return "Error: side should be either 'start' or 'end'";
...
function trimString(original, side) {
  if (side === "start") {
    return original.trimStart(side);
  } else if (side === "end") {
    return original.trimEnd(side);
  } else if (side === "both") {
    return original.trim(side);
  } else {
...
function convertCase(original, caseType) {
  if (caseType === "upper") {
    return original.toUpperCase(caseType);
  } else if (caseType === "lower") {
    return original.toLowerCase(caseType);
  } else {
